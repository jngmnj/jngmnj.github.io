    ...
    <section>
      <Link href={`/blog/${encodeURIComponent(slug)}`} className="group">
        <div className="relative mb-8 h-80 overflow-hidden rounded-2xl sm:h-96 md:mb-16 lg:h-112 xl:h-128">
          ...
          <div className="group-hover:from:30% absolute inset-0 flex flex-col justify-end bg-gradient-to-t from-black/70 from-0% via-black/20 via-20% to-transparent to-60% px-6 py-8 text-white transition-all duration-200 group-hover:via-50% group-hover:to-80%">
            ...
            <div className="mt-4 max-h-0 overflow-hidden opacity-90 transition-all duration-200 group-hover:max-h-full group-hover:opacity-100 lg:mt-6 lg:text-lg lg:leading-relaxed">
              <p className="mb-4 line-clamp-3 leading-relaxed lg:text-lg">
                {excerpt}
              </p>
            </div>
          </div>
